...
int CSolidSBCXMLFile::Init(CString strFileName)
{
...
int CSolidSBCXMLFile::GetNodeInt(CString strXPath, LPINT pnValue)
{
...
int CSolidSBCXMLFile::GetNodeFloat(CString strXPath, double* pfValue)
{
	CString strNodeValue;
	int nErr = GetNodeString(strXPath, &strNodeValue);
...
int CSolidSBCXMLFile::GetNodeString(CString strXPath, CString* pstrValue)
{
	int nReturn = 0;
...
int CSolidSBCXMLFile::Save(CString strFileName)
{
...
int CSolidSBCXMLFile::SetNodeString(CString strXPath, CString strValue)
{
	IXMLDOMNode *pNode = NULL;
...
int CSolidSBCXMLFile::SetNodeInt(CString strXPath, int nValue)
{
	CString strValue = _T("");
...
int CSolidSBCXMLFile::SetNodeFloat(CString strXPath, double dValue)
{
	CString strValue = _T("");
...
IXMLDOMNode* CSolidSBCXMLFile::FindNodeByName(CString strName)
{
